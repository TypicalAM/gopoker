		...
		<div className="bg-slate-700 h-32 w-24 rounded-xl border-2 border-dashed border-gray-500">
			{value ? (
				<div className="relative h-full w-full">
					...
					{red ? (
						<h1 className="font-bold absolute mb-5 mr-4 bottom-0 right-0 text-4xl text-gray-900 dark:text-red-500">{value}</h1>
					) : (
						<h1 className="font-bold absolute mb-5 mr-4 bottom-0 right-0 text-4xl text-gray-900 dark:text-gray-100">{value}</h1>
					)}
				</div>
			) : (
